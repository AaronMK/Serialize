#ifndef _SERIALIZE_MEMORY_STREAM_H_
#define _SERIALIZE_MEMORY_STREAM_H_
...
namespace Serialize
{
	 ...
	 */
	class SERIALIZE_EXPORT MemoryStream : public ByteStream
	{
	public:
		MemoryStream();
...
#endif // _SERIALIZE_MEMORY_STREAM_H_