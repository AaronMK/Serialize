#ifndef _SERIALIZE_BINARY_H_
#define _SERIALIZE_BINARY_H_
...
namespace Serialize::Binary
{
	...
	template<>
	SERIALIZE_EXPORT void write<std::string_view>(ByteStream* stream, const std::string_view &val);
	...
	template<>
	SERIALIZE_EXPORT void write<StdExt::StringLiteral>(ByteStream* stream, const StdExt::StringLiteral &val);
